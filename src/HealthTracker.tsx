...
//                             )}
//                         </h1>
//                         <div className="flex sm:flex-row gap-2 overflow-x-auto">
//                             <Button
//                                 variant={activeTab === 'diet' ? 'default' : 'outline'}
//                                 onClick={() => setActiveTab('diet')}
//                                 className={`${
//                                     activeTab === 'diet' ? activeButtonStyles : inactiveButtonStyles
//                                 } transition-all text-xs sm:text-sm py-1 sm:py-2 px-2 sm:px-4 min-w-fit`}
//                             >
//                                 <AppleIcon className="mr-1 h-3 w-3 sm:h-4 sm:w-4"/> Diet
//                             </Button>
//                             <Button
//                                 variant={activeTab === 'exercise' ? 'default' : 'outline'}
//                                 onClick={() => setActiveTab('exercise')}
...
//                                 } transition-all text-xs sm:text-sm py-1 sm:py-2 px-2 sm:px-4 min-w-fit`}
//                             >
//                                 <DumbbellIcon className="mr-1 h-3 w-3 sm:h-4 sm:w-4"/> Exercise
//                             </Button>
//                             <Button
//                                 variant={activeTab === 'weight' ? 'default' : 'outline'}
//                                 onClick={() => setActiveTab('weight')}
...
//                                 } transition-all text-xs sm:text-sm py-1 sm:py-2 px-2 sm:px-4 min-w-fit`}
//                             >
//                                 <ScaleIcon className="mr-1 h-3 w-3 sm:h-4 sm:w-4"/> Weight
//                             </Button>
//                         </div>
//                     </div>
//                 </motion.div>
