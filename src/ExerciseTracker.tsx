...
//     // ----------------------------------------------------------
//     // State management with new field names
//     // ----------------------------------------------------------
...
//             );
//
//             // If week view, aggregate by week
...
//             <div className="bg-gradient-to-r from-blue-500 to-blue-300 p-6 rounded-lg shadow-md mb-8">
...
//                 {/* --- TOP LEFT CARD: Add New Exercise (updated inputs) --- */}
//                 <motion.div
...
//                             className="border-white placeholder:text-white"
//                         />
//                         {/* 5. Type (select with push and pull options) */}
//                         <select
...
//                 </motion.div>
//
//                 {/* --- TOP RIGHT CARD: Recent Exercises --- */}
//                 <div
...
//     ClockIcon,
//     CalendarClockIcon,
//     LightbulbIcon // Icon for placeholder "Insights"
// } from "lucide-react";
// import {
//     LineChart,
//     Line,
...
//     // Render component
//     return (
//         <div className="container mx-auto p-6 max-w-7xl flex">
//             {/* Main Content */}
...
//                 {/* Top Row */}
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
//                     {/* --- TOP LEFT CARD: Add New Exercise --- */}
//                     <motion.div
//                         className="bg-gradient-to-r from-blue-500 to-blue-300 p-6 rounded-lg shadow-md"
//                         initial={{opacity: 0, y: -20}}
//                         animate={{opacity: 1, y: 0}}
...
//             <div
//                 className="w-1/4 bg-gradient-to-r from-blue-500 to-blue-300 p-6 rounded-lg shadow-md ml-8 flex flex-col"
//             >
//                 <h2 className="text-white text-xl font-semibold mb-4 flex items-center gap-2">
