...
//                 <div className="bg-gradient-to-r from-emerald-500 to-emerald-300 p-6 rounded-lg shadow-md mb-8">
...
//             <div
//                 className="w-1/4 bg-gradient-to-r from-emerald-500 to-emerald-300 p-6 rounded-lg shadow-md ml-8 flex flex-col">
//                 <h2 className="text-white text-xl font-semibold mb-4 flex items-center gap-2">
